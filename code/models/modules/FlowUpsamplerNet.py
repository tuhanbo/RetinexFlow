...
class FlowUpsamplerNet(nn.Module):
    ...
    def forward(self, gt=None, rrdbResults=None, z=None, embed=None, epses=None, logdet=0., reverse=False, eps_std=None,
                y_onehot=None):
        ...
        if reverse:
            ...
            z, logdet = self.encode(gt, rrdbResults, embed, logdet=logdet, epses=epses, y_onehot=y_onehot)

            return z, logdet

    def encode(self, gt, rrdbResults, embed, logdet=0.0, epses=None, y_onehot=None):
